...
tool does not speak") rather than acted on. Every trace records which protocol was
actually used in `negotiation.chosen`, measured from the handshake itself, not guessed.
